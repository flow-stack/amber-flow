define("amber-flow-app/MVC-Controllers", ["amber/boot", "amber_core/Web"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Controllers');
$core.packages["MVC-Controllers"].transport = {"type":"amd","amdNamespace":"amber-flow-app"};
