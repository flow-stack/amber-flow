define("amber-flow-app/MVC-Templates-Tests", ["amber/boot", "amber-flow-app/MVC-Templates", "amber-flow-app/MVC-Binding", "amber-flow-app/MVC-Models"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Templates-Tests');
$core.packages["MVC-Templates-Tests"].transport = {"type":"amd","amdNamespace":"amber-flow-app"};

$core.addClass('HelloWorldController', $globals.TemplateController, [], 'MVC-Templates-Tests');
...
$core.addClass('Stuff', $globals.Model, ['name', 'things'], 'MVC-Templates-Tests');
$core.addMethod(
$core.method({
selector: "name",
protocol: 'accessing',
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: ["anObject"],
source: "name: anObject\x0a\x0a\x09name := anObject",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: []
}),
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "things\x0a\x0a\x09^ things",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: []
}),
...
var self=this;
self["@things"]=someObjects;
return self;

},
//>>excludeStart("ide", pragmas.excludeIdeData);
args: ["someObjects"],
source: "things: someObjects\x0a\x0a\x09things := someObjects",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: []
}),
...
$core.addClass('StuffController', $globals.BindingController, [], 'MVC-Templates-Tests');
//>>excludeStart("ide", pragmas.excludeIdeData);
...
$core.addClass('StuffUsingEachController', $globals.BindingController, [], 'MVC-Templates-Tests');
//>>excludeStart("ide", pragmas.excludeIdeData);
...
$core.addClass('StuffComposedUsingEachController', $globals.StuffUsingEachController, [], 'MVC-Templates-Tests');
$core.addMethod(
$core.method({
...
$core.addClass('Thing', $globals.Model, ['name'], 'MVC-Templates-Tests');
$core.addMethod(
$core.method({
selector: "name",
protocol: 'accessing',
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "name\x0a\x0a\x09^ name\x0a\x09",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: []
}),
...
$core.addClass('ThingController', $globals.BindingController, [], 'MVC-Templates-Tests');
