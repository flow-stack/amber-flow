define("amber-flow-app/MVC-Core", ["amber/boot", "amber_core/Web", "minimapless/MiniMapless", "amber_core/Kernel-Objects"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Core');
$core.packages["MVC-Core"].transport = {"type":"amd","amdNamespace":"amber-flow-app"};
...
$core.addClass('RouteableController', $globals.Controller, [], 'MVC-Core');
//>>excludeStart("ide", pragmas.excludeIdeData);
...
$core.addClass('NotFoundController', $globals.RouteableController, [], 'MVC-Core');
