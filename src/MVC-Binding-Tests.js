define("amber-flow/MVC-Binding-Tests", ["amber/boot", "minimapless/MiniMapless", "amber-flow/MVC-Binding"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Binding-Tests');
$core.packages["MVC-Binding-Tests"].transport = {"type":"amd","amdNamespace":"amber-flow"};
