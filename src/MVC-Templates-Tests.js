define("amber-flow/MVC-Templates-Tests", ["amber/boot", "amber-flow/MVC-Templates", "amber-flow/MVC-Models", "amber-flow/MVC-Binding"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Templates-Tests');
$core.packages["MVC-Templates-Tests"].transport = {"type":"amd","amdNamespace":"amber-flow"};
