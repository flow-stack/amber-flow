define("amber-flow/MVC-Binding", ["amber/boot", "amber-flow/MVC-Templates", "amber_core/Kernel-Objects"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Binding');
$core.packages["MVC-Binding"].transport = {"type":"amd","amdNamespace":"amber-flow"};
