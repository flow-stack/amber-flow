define("amber-flow/MVC-Templates", ["amber/boot", "amber-flow/MVC-Controllers"], function($boot){
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
var smalltalk=$core,_st=$recv,globals=$globals;
$core.addPackage('MVC-Templates');
$core.packages["MVC-Templates"].transport = {"type":"amd","amdNamespace":"amber-flow"};
